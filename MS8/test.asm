...
00000000 <start>:
  ...
  84:	0c450513          	add	a0,a0,196 # 144 <_sidata>
...
000000d8 <delay>:
  ...
  dc:	77078793          	add	a5,a5,1904 # 1770 <_sidata+0x162c>
