...
00000000 <start>:
  ...
  84:	08450513          	add	a0,a0,132 # 104 <_sidata>
  88:	20000597          	auipc	a1,0x20000
  8c:	f7858593          	add	a1,a1,-136 # 20000000 <gpio_oe>
...
000000d8 <main>:
  ...
  dc:	0007a683          	lw	a3,0(a5) # 20000000 <gpio_oe>
  e0:	200007b7          	lui	a5,0x20000
  e4:	0047a703          	lw	a4,4(a5) # 20000004 <gpio_data>
  e8:	fff00613          	li	a2,-1
  ec:	f00fe7b7          	lui	a5,0xf00fe
  f0:	00c6a023          	sw	a2,0(a3)
  f4:	00e78793          	add	a5,a5,14 # f00fe00e <_stack+0xd00fc00e>
