...
test2.elf:     file format elf32-littleriscv
...
00000000 <start>:
  ...
  84:	0bc50513          	addi	a0,a0,188 # 13c <_sidata>
...
000000d0 <end_init_bss>:
  d0:	03c000ef          	jal	10c <main>

000000d4 <loop>:
  d4:	0000006f          	j	d4 <loop>

000000d8 <delay>:
  d8:	19000793          	li	a5,400
  dc:	02f50533          	mul	a0,a0,a5
  e0:	200007b7          	lui	a5,0x20000
  e4:	0107a683          	lw	a3,16(a5) # 20000010 <LOAD_VALUE>
  e8:	200007b7          	lui	a5,0x20000
  ec:	0147a703          	lw	a4,20(a5) # 20000014 <TIMER_STATUS>
  f0:	00100793          	li	a5,1
  f4:	00a6a023          	sw	a0,0(a3)
  f8:	00f72023          	sw	a5,0(a4)
  fc:	00072783          	lw	a5,0(a4)
 100:	1007f793          	andi	a5,a5,256
 104:	fe078ce3          	beqz	a5,fc <delay+0x24>
 108:	00008067          	ret

0000010c <main>:
 10c:	20000737          	lui	a4,0x20000
 110:	200007b7          	lui	a5,0x20000
 114:	01072583          	lw	a1,16(a4) # 20000010 <LOAD_VALUE>
 118:	0147a703          	lw	a4,20(a5) # 20000014 <TIMER_STATUS>
 11c:	32000613          	li	a2,800
 120:	00100693          	li	a3,1
 124:	00c5a023          	sw	a2,0(a1)
 128:	00d72023          	sw	a3,0(a4)
 12c:	00072783          	lw	a5,0(a4)
 130:	1007f793          	andi	a5,a5,256
 134:	fe078ce3          	beqz	a5,12c <main+0x20>
 138:	fedff06f          	j	124 <main+0x18>
